...
export const education: Education[] = [
  {
    ...
    duration: "2016 - 2021",
    description:
      "Graduated with First Class Honors. Specialized in Reservoir Engineering and Simulation.",
  },
  {
    id: "2",
    ...
    duration: "2017 - 2018",
    description:
      "Completed multiple comprehensive web development courses focusing on modern JavaScript frameworks and backend technologies.",
  },
];
